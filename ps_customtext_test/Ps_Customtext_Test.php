...
require_once _PS_MODULE_DIR_.'ps_customtext_test/classes/CustomTextTest.php';

class Ps_Customtext_Test extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Custom text blocks 1', array(), 'Modules.Customtext.Admin');
        ...
        $this->templateFile = 'module:ps_customtext_test/ps_customtext_test.tpl';
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('saveps_customtext_test')) {
    ...
    protected function renderForm()
    {
        ...
        $helper->module = $this;
        $helper->name_controller = 'ps_customtext_test';
        ...
        $helper->submit_action = 'saveps_customtext_test';
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ps_customtext_test'))) {
