...
class MigrateDataTest
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`,il.`id_lang`,il.`text`FROM`'. _DB_PREFIX_. 'info_test` i INNER JOIN`'._DB_PREFIX_.'info_test_lang` il ON il.`id_info`=i.`id_info`');
    ...
    /**
     * Import the old CustomTextTest data in the new structure
     *
     * @return bool
     */
    public function insertData()
    {
        ...
        $info_test->text = reset($customTexts);
